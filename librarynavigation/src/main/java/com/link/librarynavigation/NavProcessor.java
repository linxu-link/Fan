package com.link.librarynavigation;
...
@SupportedAnnotationTypes({"com.link.libraryannotation.FragmentDestination", "com.link.libraryannotation.ActivityDestination"})
