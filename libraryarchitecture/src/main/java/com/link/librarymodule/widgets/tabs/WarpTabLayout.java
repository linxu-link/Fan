...
public class WarpTabLayout extends HorizontalScrollView {
    ...
    private final SlidingTabIndicator mTabStrip;
    ...
    public WarpTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new SlidingTabIndicator(context);
        ...
        TypedArray ma = context.obtainStyledAttributes(attrs,
    ...
    public static final class Tab {
         ...
         * to {@link #setText(CharSeq)}. Similarly, if this layout contains an
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            // draw src xxl on
            canvas.drawRect(left, getHeight() - mSelectedIndicatorHeight - mIndicatorMarginBottom, right, getHeight() - mIndicatorMarginBottom, mSelectedIndicatorPaint);
