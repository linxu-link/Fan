package com.link.fan.widgets.exoplayer;
...
import com.link.fan.widgets.PPImageView;
...
public class ListPlayerView extends FrameLayout implements IPlayTarget, PlayerControlView.VisibilityListener, Player.EventListener {
    ...
    protected void onDetachedFromWindow() {
        ...
        playBtn.setImageResource(R.mipmap.icon_video_play);
    }
    ...
    public void onVisibilityChange(int visibility) {
        ...
        playBtn.setImageResource(isPlaying() ? R.mipmap.icon_video_pause : R.mipmap.icon_video_play);
    }
