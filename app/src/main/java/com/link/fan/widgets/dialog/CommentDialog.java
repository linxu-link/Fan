package com.link.fan.widgets.dialog;
...
import com.link.fan.app.capture.CaptureActivity;
import com.link.fan.data.bean.Comment;
import com.link.fan.databinding.LayoutCommentDialogBinding;
import com.link.fan.utils.FileUtils;
import com.link.fan.utils.PixUtils;
import com.link.fan.widgets.ViewHelper;
...
//                });
    ...
    private void showToast(String s) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            Toast.makeText(ApplicationUtil.getApplication(), s, Toast.LENGTH_SHORT).show();
        } else {
            ArchTaskExecutor.getMainThreadExecutor().execute(() -> Toast.makeText(ApplicationUtil.getApplication(), s, Toast.LENGTH_SHORT).show());
        }
    }
